...
export default ({ Box }: { Box: typeof Box }) => ({
  Horizontal: () => (
    <div>
      ...
      <Test name="horizontal children visibility at different breakpoints">
        <Box horizontal hAlign="spaceAround">
          <Box>
            <DebugBox />
          </Box>
  ...
  HorizontalColumns: () => (
    <div>
      ...
      <Test name="horizontal columns with responsive widths with sparse array">
        <Box stacked>
          <Box horizontal wrap>
            <DebugBox w={[12 / 12, , 3 / 12]} />
            <DebugBox w={[12 / 12, , 9 / 12]} />
      ...
      <Test name="horizontal columns with responsive widths with nulls in array">
        <Box stacked>
          <Box horizontal wrap>
            <DebugBox w={[12 / 12, null, 3 / 12]} />
            <DebugBox w={[12 / 12, null, 9 / 12]} />
          </Box>
          <Box horizontal wrap>
            <DebugBox w={[null, null, 2 / 12]} />
            <DebugBox w={[null, null, 10 / 12]} />
          </Box>
        </Box>
      </Test>

      <Test name="horizontal columns reordering at different breakpoints">
        <Box horizontal wrap>
          <Box w={[12 / 12, 9 / 12]} order={[1, 0]}>
            <DebugBox label="<Content />" />
          </Box>
          <Box w={[12 / 12, 3 / 12]} order={[0, 1]}>
            <DebugBox label="<Icon />" />
          </Box>
        </Box>
      </Test>

      <Test name="horizontal columns visibility at different breakpoints">
        <Box horizontal wrap>
          <Box w={[12 / 12, 9 / 12]}>
            <DebugBox label="<Content />" />
          </Box>
          <Box w={[12 / 12, 3 / 12]} visible={[false, true]}>
            <DebugBox label="<Icon />" />
          </Box>
        </Box>
      </Test>
